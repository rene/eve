...
PLATFORMS_arm64=generic nvidia-jp5 nvidia-jp6 imx8mp_pollux imx8mp_epc_r3720 imx8mq_evk qcom-iq9
...
ifeq ($(ZARCH), amd64)
    ...
    ifeq (qcom, $(findstring qcom,$(PLATFORM)))
        KERNEL_FLAVOR=qcom-iq9
        KERNEL_VERSION=v6.6.116
