...
// Validates a CAN property name
func validatePropertyName(prop string) bool {
	allowedProps := []string{"bitrate", "sample-point", "tq", "prop_seg",
		"phase_seg1", "phase_seg2", "sjw", "dbitrate", "dsample-point",
		"dtq", "dprop_seg", "dphase_seg1", "dphase_seg2", "dsjw", "loopback",
		"listen-only", "triple-sampling", "one-shot", "berr-reporting",
		"fd", "fd-non-iso", "presume-ack", "cc-len8-dlc", "termination",
		"tdc-mode", "tdco", "tdcv", "tdcf", "restart", "restart-ms",
	}
	found := false
